...
class IssuePolicy
{
     ...
     * @return mixed
     */
    public function view(User $user, Issue $model)
    {
     ...
     * @return mixed
     */
    public function update(User $user, Issue $model)
    {
     ...
     * @return mixed
     */
    public function delete(User $user, Issue $model)
    {
     ...
     * @return mixed
     */
    public function restore(User $user, Issue $model)
    {
        return false;
    }
     ...
     * @return mixed
     */
    public function forceDelete(User $user, Issue $model)
    {
        return false;
    }
}
